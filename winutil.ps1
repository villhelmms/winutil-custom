...
$inputXML =  '<Window x:Class="WinUtility.MainWindow"
        ...
        WindowStyle="None"
        Title="Chris Titus Tech''s Windows Utility - Customized" Height="800" Width="1280">
                    ...
                    <Grid.ColumnDefinitions>
                        ...
                        <StackPanel Orientation="Horizontal" Margin="0,5,0,0">
                            ...
                            <ComboBox Name="WPFchangedns"  Height="32" Width="186" HorizontalAlignment="Left" VerticalAlignment="Center" Margin="5,5" FontSize="{FontSize}">
                                ...
                                <ComboBoxItem  Content="VJCG_A" FontSize="{FontSize}"/>
                                <ComboBoxItem  Content="VJCG_R" FontSize="{FontSize}"/>
